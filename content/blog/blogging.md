...
Being an experiment, I expect a lot of what I do and how I go about it to change. I'm likely to tweak my text editor, [neovim](https://neovim.io/) to be more comfortable with writing long-form english language content. Having an autocomplete with suggested words would be quite nice, beyond the ones I do get as [blink.cmp](https://github.com/Saghen/blink.cmp) scrambles to predict what I'm typing using what I've written elsewhere in the file. I may incorporate [Obsidian](https://obsidian.md/) and turn this place into more of a 'digital garden'. Then again, I might simply migrate to a different static site generator besides [Hugo](https://gohugo.io/) and stick with it till the day no one is left to speak time's name. I know that the only reason I'm not using [Jekyll](https://jekyllrb.com/) is because of its Ruby-forged dependency hell.
